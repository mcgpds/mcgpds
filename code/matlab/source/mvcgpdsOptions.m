function options = mvcgpdsOptions(Ytr, globalOpt, labelsTrain)

% mvcgpdsOptions  Creates an options structure which is used for creating a mvcgpds model.
% FORMAT
% DESC Takes a cell array of output modalities and a global options structure and (optionally) a training
% labels vector, and returns an options structure which is used for creating the mvcgpds model
%
