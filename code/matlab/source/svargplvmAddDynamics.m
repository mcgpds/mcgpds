function  model = svargplvmAddDynamics(model, globalOpt, optionsDyn, samd)
...
% VARGPLVM
    ...
    model = vargplvmAddDynamics(model, 'vargpTime', samd, optionsDyn, optionsDyn.t, 0, 0,optionsDyn.seq);
    ...
    model = vargplvmInitDynamics(model,optionsDyn, samd);
